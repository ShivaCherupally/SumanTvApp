package info.sumantv.flow.ipoll.adapters.feeds;
...
import info.sumantv.flow.appmanagers.feed.models.SuggestionsModel;
...
import info.sumantv.flow.bottommenu.viewholders.LoaderViewHolder;
import info.sumantv.flow.bottommenu.viewholders.RetryViewHolder;
...
import info.sumantv.flow.ipoll.adapters.feeds.celebrities.FeedSuggestionsAdapter;
import info.sumantv.flow.ipoll.adapters.feeds.celebrities.FeedSuggestionsOnWelcomeAdapter;
import info.sumantv.flow.ipoll.adapters.feeds.celebrities.OnlineCelebritiesAdapter;
import info.sumantv.flow.ipoll.adapters.feeds.celebrities.StoriesAdapter;
import info.sumantv.flow.ipoll.dialogs.custom.AddCommentDialog;
...
import info.sumantv.flow.ipoll.interfaces.recyclerview.IRecyclerViewAdapter;
import info.sumantv.flow.ipoll.viewholders.CreateStoriesViewHolder;
...
import static info.sumantv.flow.bottommenu.activity.BottomMenuActivity.isCurvedBottomBar;
