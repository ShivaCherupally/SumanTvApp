package info.sumantv.flow.menu_list.MyContent.MyPostsActivity;
...
public class MyPostAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MyPostAdapter(RController rController) {
        this.rController = rController;
    }

    public MyPostAdapter(Context context, List<Feed> feedList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, final int viewType) {
        if (rController == RController.LOADING) {
            ...
            MyPostAdapter.MyViewHolder myViewHolder = new MyPostAdapter.MyViewHolder(view);
            return myViewHolder;
        }
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holderGlobal, int position) {
        ...
        if (holderGlobal instanceof MyPostAdapter.MyViewHolder) {

            MyPostAdapter.MyViewHolder holder = (MyPostAdapter.MyViewHolder) holderGlobal;
