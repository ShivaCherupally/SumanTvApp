package info.sumantv.flow.menu_list.Preferences;
 ...
 */
public class ExpandablePreferenceGridView extends GridView {
    ...
    public ExpandablePreferenceGridView(Context context) {
        this(context, null);
    }

    public ExpandablePreferenceGridView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ExpandablePreferenceGridView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void expandGridViewAtView(View clickedView, final BaseAdapter expandGridAdapter){
        ...
        int middleViewHeight = clickedView.getHeight();// height of middle sub grid view
        ...
        LayoutParams gridParams = new LayoutParams(count*(getColumnWidth()+0),
