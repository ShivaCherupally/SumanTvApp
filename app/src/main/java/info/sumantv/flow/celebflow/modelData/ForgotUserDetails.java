...
/**
 * Created by Uday Kumay Vurukonda on 08-May-19.
 * <p>
 * Mr.Psycho
 */
public class ForgotUserDetails implements Parcelable{
    ...
    protected ForgotUserDetails(Parcel in) {
        id = in.readString();
    ...
    public static final Creator<ForgotUserDetails> CREATOR = new Creator<ForgotUserDetails>() {
        @Override
        public ForgotUserDetails createFromParcel(Parcel in) {
            return new ForgotUserDetails(in);
        }

        @Override
        public ForgotUserDetails[] newArray(int size) {
            return new ForgotUserDetails[size];
        }
    };
}
