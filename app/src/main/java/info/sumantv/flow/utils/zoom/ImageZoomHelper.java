package info.sumantv.flow.utils.zoom;
    ...
    public boolean onDispatchTouchEvent(MotionEvent ev) {
        ...
        if (ev.getPointerCount() == 2) {
            if (zoomableView == null) {
                ...
                View view = findZoomableView(ev, activity.findViewById(R.id.frameLayoutHelper).getVisibility() == View.VISIBLE ? activity.findViewById(R.id.frameLayoutHelper) :
...
//                    dialog.getWindow().getAttributes().windowAnimations = R.style.zoomDialogAnimation;
                    ...
                    zoomableView.buildDrawingCache();

                    BitmapDrawable placeholderDrawable = null;
                    try {
                        placeholderDrawable = new BitmapDrawable(
    ...
    private View findZoomableView(MotionEvent event, View view) {
        if (view instanceof ViewGroup) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (child.getTag(R.id.un_zoomable) == null) {
    ...
    public static void setZoom(View view, boolean enabled) {
        view.setTag(R.id.un_zoomable, enabled ? null : new Object());
    }
